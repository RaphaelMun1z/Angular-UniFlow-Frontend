...
import { GroupManagementPageComponent } from './pages/generic-pages/group-management-page/group-management-page.component';
import { GroupPageComponent } from './pages/generic-pages/group-page/group-page.component';
